...
{
    /// <summary>
    /// Provides methods for retrieving pages of type Doctors.
    /// </summary>
    public partial class DoctorsProvider
    {
        /// <summary>
        /// Returns a query that selects published pages of type Doctors.
        /// </summary>
        public static DocumentQuery<Doctors> GetDoctors()
        {
            return DocumentHelper.GetDocuments<Doctors>().PublishedVersion().Published();
        }


        /// <summary>
        /// Returns a published page of type Doctors that matches the specified criteria.
        /// </summary>
        ...
        public static DocumentQuery<Doctors> GetDoctors(int nodeId, string cultureName, string siteName)
        {
        ...
        /// <param name="siteName">The name of the site where the page belongs.</param>
        /// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
        public static DocumentQuery<Doctors> GetDoctors(Guid nodeGuid, string cultureName, string siteName)
        {
        ...
        /// <param name="siteName">The name of the site where the page belongs.</param>
        /// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
        public static DocumentQuery<Doctors> GetDoctors(string nodeAliasPath, string cultureName, string siteName)
        {
